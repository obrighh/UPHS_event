...
<body>
    ...
    <section class="contact-from-section spad">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="actions/contacts.php" method="post" class="comment-form contact-form">
                        <div class="row">
                            <div class="col-lg-4">
                                <input type="text" name="name" placeholder="Name" required maxlength="200">
                            </div>
                            <div class="col-lg-4">
                                <input type="email" name="email" placeholder="Email" required maxlength="200">
                            </div>
                            <div class="col-lg-4">
                                <input type="text" name="phone" placeholder="Phone">
                            </div>
                            <div class="col-lg-12 text-center">
                                <textarea name="message" placeholder="Messages" required maxlength="8000"></textarea>
                                <button type="submit" name="submitContact" value="1" class="site-btn">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
