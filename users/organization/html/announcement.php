<?php
  ...
  "SELECT
   ...
   WHERE u_id = ? AND a_status = ?
  ";

  $stmt = $conn->prepare($sql);
  $stmt -> bind_param("ii", $u_id, $able);
  $stmt->execute();
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="modal fade" id="addLogbookModal" tabindex="-1" aria-labelledby="addLogbookModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <form action="../../../actions/add_announcement.php" method="POST" class="modal-content">
                      ...
                      <tbody>
                        ...
                        <?php
                          ...
                          while($row = mysqli_fetch_assoc($result)) {
                            ...
                            <div class='modal-dialog'>
                              <form action='../../../actions/edit_announcement.php' method='POST' class='modal-content'>
                                <div class='modal-header'>
                          ...
                          <div class='modal fade' id='deleteModal$a_id' tabindex='-1' aria-hidden='true'>
                            <div class='modal-dialog modal-dialog-centered'>
                              <form action='../../../actions/delete_announcement.php' method='POST' class='modal-content'>
                                <div class='modal-header'>
