              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="modal fade" id="addLogbookModal" tabindex="-1" aria-labelledby="addLogbookModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <form action="../../../actions/dean_addAnnounce.php" method="POST" class="modal-content">
                      ...
                      <tbody>
                        ...
                        <?php
                          ...
                          while($row = mysqli_fetch_assoc($result)) {
                            ...
                            <div class='modal-dialog'>
                              <form action='../../../actions/dean_editAnnounce.php' method='POST' class='modal-content'>
                                <div class='modal-header'>
                          ...
                          <div class='modal fade' id='deleteModal$a_id' tabindex='-1' aria-hidden='true'>
                            <div class='modal-dialog modal-dialog-centered'>
                              <form action='../../../actions/dean_deleteAnnounce.php' method='POST' class='modal-content'>
                                <div class='modal-header'>
